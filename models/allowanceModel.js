function AppViewModel() {
    ...
    self.showDropList = function(){
      ...
      this.items = ko.observableArray([
          {
              id: 1,
              allowanceName: 'A1-2233',
              editedBy: 'John Darsey',
              peroidicity: 'Bill Cycle',
              originatingCalls : '500',
              terminatingCalls : '1500',
              totalCalls: '120',
              totalCallsDuration: '2000',
              originatingDuration: '2000',
              terminatingDuration: '1500',
